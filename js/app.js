...
const whatsappLinkGenerator = (phoneNumber, productTitle, productQuantity, buyerName, buyerAddress, buyerPayment) => `https://api.whatsapp.com/send?phone=${phoneNumber}&text=Olá, eu gostaria de encomendar um(a) ${productTitle} para o endereço: ${buyerAddress} \n- Cliente: ${buyerName} \n- Forma de pagamento: ${buyerPayment} \n- Quantidade: ${productQuantity}`

const checkout = phoneNmber => {
    ...
    form.addEventListener('submit', e => {
        ...
        const whatsappUrl = whatsappLinkGenerator(phoneNmber, productTitle, productQuantity, buyerName, buyerAddress, buyerPayment)
